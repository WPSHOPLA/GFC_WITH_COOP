                    ...
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            ...
                            <div class="form-group" style="padding: 15px;">
                                <input type="text" name="section_email" class="form-control"
                            ...
                            request.onreadystatechange = function (response) {
                                if (request.readyState === 4) {
                                    if (request.status === 200) {
                                        ...
                                        var posObj = {
                                            startOffset: jsonHighlight.highlight_start,
                                            endOffset: jsonHighlight.highlight_end
                                        };
                                    ...
                                    if (request.status === 200) {
                                        ...
                                        if (jsonHighlight.highlight_status == 'success') {
                                            ...
                                            if (jsonHighlight.start != -1 && jsonHighlight.end != -1)
                                                highlightBookmark({
                                                    startOffset: jsonHighlight.start,
                                                    endOffset: jsonHighlight.end
                                                });
