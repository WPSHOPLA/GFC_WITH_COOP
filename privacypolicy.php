...
<div class="container-fluid content">
  ...
  <div class="row-fluid privacy-policy" style="padding-top: 30px;">
	  <div class="row-fluid">
		<h3>Privacy Policy</h3>
		<h5>Last updated: April 21, 2016</h5><br/>
	  </div>
	  <div class="row-fluid">
		<p>
			ENGEO Software Services L.L.C. ("us", "we", or "our") operates the http://www.gofetchcode.com website and the GoFetchCode mobile 
	  ...
	  <div class="row-fluid" style="padding-top: 5px;">
		...
		<p>
			...
			information ("Personal Information"). We collect this information for the purpose of providing 
			the Service, identifying and communicating with you, responding to your requests/inquiries, 
	  ...
	  <div class="row-fluid" style="padding-top: 5px;">
		...
		<p>
			...
			access the Service by or through a mobile device ("Log Data").	
		</p>
		...
		<p>
			When you access the Service by or through a mobile device, this Log Data may include information 
			such as the type of mobile device you use, your mobile device unique ID, the IP address of your 
			mobile device, your mobile operating system, the type of mobile Internet browser you use and other 
			statistics.	
		</p>
		...
		<p>
			Please see the section regarding Location Information below regarding the use of your location 
			information and your options.	
		</p>				
	  </div> 
	  <div class="row-fluid" style="padding-top: 5px;">
		<h5>Location Information</h5>
		<p>
			We may use and store information about your location depending on the permissions you have set 
			on your device. We use this information to provide features of our Service, to improve and 
			customize our Service. You can enable or disable location services when you use our Service at 
	  ...
	  <div class="row-fluid" style="padding-top: 5px;">
		...
		<p>
			...
			Cookies are sent to your browser from a web site and transferred to your device. We use cookies to 
			collect information in order to improve our services for you.
		</p>
		<p>
	
			You can instruct your browser to refuse all cookies or to indicate when a cookie is being sent. 
			The Help feature on most browsers provide information on how to accept cookies, disable cookies or 
			to notify you when receiving a new cookie.
		</p>
		<p>
	  ...
	  <div class="row-fluid" style="padding-top: 5px;">
		...
		<p>
			...
			our Service or other web sites on the Internet.
		</p>
		<p>
			You may opt out of the use of the DoubleClick Cookie for interest-based advertising by visiting 
			the Google Ads Settings web page: <a href="http://www.google.com/ads/preferences/">http://www.google.com/ads/preferences/</a>
		</p>		
	  </div>
	  <div class="row-fluid" style="padding-top: 5px;">
		<h5>Behavioral Remarketing</h5>
		<p>
			ENGEO Software Services L.L.C. uses remarketing services to advertise on third party web sites to 
		...
		<p>
			<ul>
				...
				<li>
					You can opt-out of Google Analytics for Display Advertising and customize the Google Display Network 
					ads by visiting the Google Ads Settings page: <a href="http://www.google.com/settings/ads">http://www.google.com/settings/ads</a>
				</li>			
				<li>
					Google also recommends installing the Google Analytics Opt-out Browser Add-on - 
					<a href="https://tools.google.com/dlpage/gaoptout">https://tools.google.com/dlpage/gaoptout</a> - for your web browser. 
					Google Analytics Opt-out Browser Add-on provides visitors with the ability to prevent their data from being collected and used by 
					Google Analytics.
				</li>			
				<li>
		...
		<p>
			<ul>
				...
				<li>
					...
					web page: <a href="http://info.evidon.com/pub_info/573?v=1&nt=1&nw=false">http://info.evidon.com/pub_info/573?v=1&nt=1&nw=false</a>
				</li>			
				<li>
					For more information on the privacy practices of AdRoll, please visit the AdRoll 
					Privacy Policy web page: <a href="http://www.adroll.com/about/privacy">http://www.adroll.com/about/privacy</a>
				</li>									
			</ul>
		</p>				
	  </div> 
	  ...
	  <div class="row-fluid" style="padding-top: 5px;">
		...
		<p>
			We will disclose your Personal Information where required to do so by law or subpoena or if 
			we believe that such action is necessary to comply with the law and the reasonable requests of 
			law enforcement or to protect the security or integrity of our Service.
		</p>		
	  </div>
	  <div class="row-fluid" style="padding-top: 5px;">
		<h5>Business Transaction</h5>
		<p>
			If ENGEO Software Services L.L.C. is involved in a merger, acquisition or asset sale, your 
			Personal Information may be transferred as a business asset. In such cases, we will provide 
			notice before your Personal Information is transferred and/or becomes subject to a different 
			Privacy Policy.
		</p>		
	  </div>     
	  <div class="row-fluid" style="padding-top: 5px;">
		<h5>Security</h5>
		<p>
			The security of your Personal Information is important to us, and we strive to implement 
			and maintain reasonable, commercially acceptable security procedures and practices 
			appropriate to the nature of the information we store, in order to protect it from 
	  ...
	  <div class="row-fluid" style="padding-top: 5px;">
		...
		<p>
			We do not knowingly collect personally identifiable information from children under 13. If you are 
			a parent or guardian and you learn that your Children have provided us with Personal Information, 
			please contact us. If we become aware that we have collected Personal Information from a children 
			under age 13 without verification of parental consent, we take steps to remove that information 
			from our servers.
		</p>				
	  </div>  
	  <div class="row-fluid" style="padding-top: 5px;">
		...
		<p>
			This Privacy Policy is effective as of April 21, 2016 and will remain in effect except with 
